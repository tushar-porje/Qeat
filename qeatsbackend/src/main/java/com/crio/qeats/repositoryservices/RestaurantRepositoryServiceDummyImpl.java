...
public class RestaurantRepositoryServiceDummyImpl implements RestaurantRepositoryService {
  ...
  // private List<Restaurant> loadRestaurantsDuringPeekHours() throws IOException {
  //   String fixture =
  ...
  public List<Restaurant> findAllRestaurantsCloseBy(Double latitude, Double longitude,
    ...
    try {
      // if(servingRadiusInKms==5.0){
        restaurantList = loadRestaurantsDuringNormalHours();
      // }else if(servingRadiusInKms==3.0){
      //   restaurantList = loadRestaurantsDuringPeekHours();
      // }
    } catch (IOException e) {
      e.printStackTrace();
    }
