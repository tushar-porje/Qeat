...
public class RestaurantServiceImpl implements RestaurantService {
  ...
  public GetRestaurantsResponse findAllRestaurantsCloseBy(GetRestaurantsRequest getRestaurantsRequest, LocalTime currentTime) {
        ...
        double longi=getRestaurantsRequest.getLongitude();
        ...
        //   || (h >= 19 && h <= 20) || (h == 21 && m == 0))
        {
          restaurants=restaurantRepositoryService.findAllRestaurantsCloseBy(lat, longi, currentTime, peakHoursServingRadiusInKms);
          //if less restaurant than increase radius
        }else{
          restaurants=restaurantRepositoryService.findAllRestaurantsCloseBy(lat, longi, currentTime, normalHoursServingRadiusInKms); 
        }
